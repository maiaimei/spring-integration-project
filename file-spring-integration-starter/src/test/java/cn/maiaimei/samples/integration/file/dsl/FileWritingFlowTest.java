...
public class FileWritingFlowTest {
  ...
  public static void teardownAll() throws IOException {
    FileUtils.deleteDirectory(FileUtils.getOrCreateDirectory("/tmp/file-writing"));
  }
  ...
  public void testFileWritingFlow() throws InterruptedException {
    ...
    final List<File> files = FileUtils.listFiles("/tmp/file-writing");
    ...
    public IntegrationFlow fileWritingFlow() {
      return IntegrationFlow.from("fileWritingInput")
          .enrichHeaders(h -> h.header(FileHeaders.FILENAME, "foo.txt")
              .header("directory", FileUtils.getOrCreateDirectory("/tmp/file-writing")))
