...
/**
 * Demonstrates use of the outbound gateway to use ls, get and rm. Creates a temporary directory
 * with 2 files; retrieves and removes them.
 *
 * @author Gary Russell
 * @since 2.1
 */
...
public class SftpOutboundGatewaySample {
  ...
  public void testLsGetRm() {
    ...
    log.info("java.io.tmpdir is {}", System.getProperty("java.io.tmpdir"));
