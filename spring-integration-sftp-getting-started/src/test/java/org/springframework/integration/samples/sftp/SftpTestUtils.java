...
public class SftpTestUtils {
  ...
  public static void createTestFiles(RemoteFileTemplate<SftpClient.DirEntry> template,
  ...
  public static void cleanUp(RemoteFileTemplate<SftpClient.DirEntry> template,
      final String... fileNames) {
    if (template != null) {
      template.execute((SessionCallback<SftpClient.DirEntry, Void>) session -> {
        for (int i = 0; i < fileNames.length; i++) {
  ...
  public static boolean fileExists(RemoteFileTemplate<SftpClient.DirEntry> template,
      final String... fileNames) {
    if (template != null) {
